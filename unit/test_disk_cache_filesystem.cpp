...
TEST_CASE("Test disk cache validation with mismatched version tags", "[on-disk cache filesystem test]") {
	constexpr uint64_t test_block_size = 10;
	*g_on_disk_cache_directories = {TEST_ON_DISK_CACHE_DIRECTORY};
	g_cache_block_size = test_block_size;
	g_enable_cache_validation = true;
...
TEST_CASE("Test disk cache validation with missing version tag in cache file", "[on-disk cache filesystem test]") {
	constexpr uint64_t test_block_size = 10;
	*g_on_disk_cache_directories = {TEST_ON_DISK_CACHE_DIRECTORY};
	g_cache_block_size = test_block_size;
...
TEST_CASE("Test disk cache with validation disabled", "[on-disk cache filesystem test]") {
	constexpr uint64_t test_block_size = 10;
	*g_on_disk_cache_directories = {TEST_ON_DISK_CACHE_DIRECTORY};
	g_cache_block_size = test_block_size;
